    ...
    var t = function () {
        ...
        d = function () {
            ...
            (e > 0 ? e : screen.height) &&
                ...
                "mini" === $("body").attr("data-sidebar-style") && $(".deznav .metismenu").height() > window.innerHeight - 60 && $(".content-body").css("min-height", $(".deznav .metismenu").height() + 60 + "px"));
        },
        h = function () {
        ...
        y = function () {
            jQuery("#lightgallery").length > 0 && $("#lightgallery").lightGallery({ loop: !0, thumbnail: !0, exThumbImage: "data-exthumbimage" }),
                jQuery("#lightgallery2").length > 0 && $("#lightgallery2").lightGallery({ loop: !0, thumbnail: !0, exThumbImage: "data-exthumbimage" });
        },
        x = function () {
        ...
        w = function () {
            jQuery("#datetimepicker1").length > 0 && $("#datetimepicker1").datetimepicker({ inline: !0 }),
                jQuery(".bt-datepicker").length > 0 && $(".bt-datepicker").datepicker({ autoclose: !0, todayHighlight: !0 }).datepicker("update", new Date());
        },
        F = function () {
            jQuery("#ckeditor").length > 0 &&
                ClassicEditor.create(document.querySelector("#ckeditor"), { simpleUpload: { uploadUrl: "ckeditor-upload.php" } })
                    .then((e) => {
                        window.editor = e;
                    })
                    .catch((e) => {
        ...
        A = function () {
            var e = {
                init: function () {
                    ...
                    new Sortable.default(e, { draggable: ".draggable", handle: ".draggable.draggable-handle", mirror: { appendTo: "body", constrainDimensions: !0 } }).on("drag:stop", () => {
                        setTimeout(function () {
                            var e;
                            (e = 0),
            ...
            parseInt($(".header").css("height"), 10),
                $(".navbar-nav .scroll").on("click", function (e) {
                    if ((e.preventDefault(), jQuery(".navbar-nav .scroll").parent().removeClass("active"), jQuery(this).parent().addClass("active"), "" !== this.hash)) {
                        ...
                        $("html, body").animate({ scrollTop: t - n }, 800, function () {});
                    }
                }),
                S();
        },
        ...
        H = function () {
            if (jQuery(".dz-theme-mode").length > 0) {
                jQuery(".dz-theme-mode").on("click", function () {
                    jQuery(this).toggleClass("active"),
                        jQuery(this).hasClass("active") ? (jQuery("body").attr("data-theme-version", "dark"), setCookie("version", "dark")) : (jQuery("body").attr("data-theme-version", "light"), setCookie("version", "light"));
                });
        ...
        Y = function () {
            $(".btn-follow").click(function () {
                var e = $(this);
                "Follow" == e.text()
                    ? (e.text("Following"), e.css({ "border-color": "#e7e7e7", "background-color": "#e7e7e7", color: "black" }))
                    : (e.text("Follow"), e.css({ "border-color": "#58bad7", "background-color": "#58bad7", color: "#fff" }));
            });
        };
    return {
        init: function () {
            i(), o(), s(), c(), r(), d(), h(), u(), f(), v(), g(), p(), b(), k(), C(), y(), x(), z(), w(), F(), m(), E(), A(), q(), t(), T(), l(), _(), H(), a(), Y();
        },
        load: function () {
