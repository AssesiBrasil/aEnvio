...
<body style="background-image:url('assets_theme/images/bg.png'); background-position:center;">
                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
									<div class="text-center mb-3">
										<a href="index.html"><img src="assets_theme/images/logo/logo-full.png" alt=""></a>
									</div>
                                    <h4 class="text-center mb-4">Faça o login</h4>
